...
export default function Banner() {
  return (
    ...
    <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row dark:bg-slate-900 dark:text-white'>
        <div className='md:w-1/2 mt-20 md:mt-32'>
           ...
           <h1 className='text-4xl font-bold'>Hello, Welcome here to learn something <span className='text-pink-500'>new everyday!!!</span></h1>
            <p className='text-xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil necessitatibus modi fugiat nulla neque voluptates vero consequuntur voluptatibus! Est, dicta.</p>
...
<button className="mt-6 btn btn-secondary">Secondary</button>
        ...
        <div className='md:w-1/2 mt-12 md:ml-6 rounded'>
