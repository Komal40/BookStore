...
function Navbar() {
  ...
  return (
    <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50  ${
      sticky?'sticky-navbar shadow-md bg-base-100 duration-300 transition-all ease-in-out dark:bg-slate-900 dark:text-white':''
    }`}>
...

  {
    user?<Logout/>:(
      <>
      <div className="">
      <a className="btn bg-black text-white hover:bg-slate-800 duration-350 cursor-pointer"
